...
import {
  ownerFindNotification,
  userFindNotification,
} from "../../app/usecases/notification/findNotification";
import {
  UserupdateNotification,
  updateNotificationStatus,
} from "../../app/usecases/notification/updateNotification";
...
export const createNotifications = async (req: Request, res: Response) => {
  ...
  try {
    const create = createNotification(notificationRepo)(
      userId,
      ownerId,
      stadiumid,
      username,
...
export const findOnwerNotifications = async (req: Request, res: Response) => {
  ...
  try {
    const findNotification = await ownerFindNotification(notificationRepo)(
      ownerId,
      stadiumId
    );
...
export const updateStatus = async (req: Request, res: Response) => {
  ...
  try {
    const update = await updateNotificationStatus(notificationRepo)(
      ownerId,
      Id
    );
...
export const UserupdateStatus = async (req: Request, res: Response) => {
  ...
  try {
    const update = await UserupdateNotification(notificationRepo)(
      ownerId,
      userId
    );
...
export const findUserNotification = async (req: Request, res: Response) => {
  ...
  try {
    const find = await userFindNotification(notificationRepo)(
      ownerId,
      stadiumid,
      userId
    );
